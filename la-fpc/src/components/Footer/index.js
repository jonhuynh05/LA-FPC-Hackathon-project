            ...
            <div>
                ...
                <SecondDiv>
                    <Button
                        ...
                        to='/SignIn'
                        color="inherit"
                        style={{ color: 'white', fontWeight: 'bold', display: 'flex', flexWrap: 'wrap' }}
                    >
                        Admin Login
                </Button>
                    <p style={{ width: '100%', textAlign: 'center', marginTop: '0' }}>Copyright © 2018 Los Angeles Food Policy Council. All Rights Reserved</p>
                </SecondDiv>
            </div >
        )
    }
